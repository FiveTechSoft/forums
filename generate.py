...
@media (max-width:700px) {
  ...
  .navbar { padding:8px 10px; font-size:16px; line-height:2; }
  .navbar a { margin-right:12px; }
  .crumbs { font-size:15px; padding:8px 4px; }
  .cat { font-size:16px; padding:8px 10px; }
  .cat .newbtn { position:static; display:inline-block; margin-left:8px; font-size:14px; }
  ...
  .body .content { font-size:17px; }
  .body .content pre, .codebox pre { font-size:14px; }
